## PACK BIND checklist — architecture/atu-merlin-vat/
...
Evidence:
- Waiver: architecture/atu-merlin-vat/ADR/0001-vat-shared-fvat-ts-postgres.md (WAIVED_PATHFINDER)
- Discovery: discovery/vat-module/features/
- REPLAY_GREEN: not required (pathfinder waiver)
- Field red-pen: 9/10 — Silent-zero + related risks named; shared fvat reuse OK
...
Talk-track: residual VAT / FVAT shared module conversion law BOUND — not Merlin migrated.
