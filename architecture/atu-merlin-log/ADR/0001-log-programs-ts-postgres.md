# ADR 0001 — LOG programs: TypeScript shared logging / samlog align (BOUND)

## Status

Accepted — pack `atu-merlin-ts-log-v1` @ version 1 is **BOUND**. Does **not** authorise Convert (separate ROOM_OK required).
