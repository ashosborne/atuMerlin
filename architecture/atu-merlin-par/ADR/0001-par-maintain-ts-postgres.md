# ADR 0001 — PAR maintain: TypeScript shared parm / PATH (DRAFT)

## Status

Proposed — pack `atu-merlin-ts-par-v1` @ version 1 is **DRAFT**. Does **not** authorise Convert (separate ROOM_OK required after BOUND).
