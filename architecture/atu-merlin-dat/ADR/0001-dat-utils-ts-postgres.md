# ADR 0001 — DAT utils: TypeScript shared date helpers (DRAFT)

## Status

Proposed — pack `atu-merlin-ts-dat-v1` @ version 1 is **DRAFT**. Does **not** authorise Convert (separate ROOM_OK required after BOUND).
