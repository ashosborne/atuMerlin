## PACK BIND checklist — architecture/atu-merlin-dat/
...
Evidence:
- Waiver: architecture/atu-merlin-dat/ADR/0001-dat-utils-ts-postgres.md (WAIVED_PATHFINDER)
- Discovery: discovery/dat-utils/features/
- REPLAY_GREEN: not required (pathfinder waiver)
- Field red-pen: 9/10 — Date lock matches ORD (NULL / sentinel at boundary)
...
Talk-track: residual DAT date utilities conversion law BOUND — not Merlin migrated.
