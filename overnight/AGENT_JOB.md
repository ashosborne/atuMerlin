...
# ROOM_OK: convert CUS vertical only (cus-interactive + cus-modules)
# Pack: atu-merlin-ts-cus-v1@1 BOUND (architecture/atu-merlin/PACK.yaml)
# WAIVED_PATHFINDER — COMPARE at TypeScript API only. No IBM i / COBOL goldens.
# SME c04/c08/c11 as-is. Talk-track: pathfinder CUS vertical — not Merlin migrated.
# Note: Pack B run 4 (ord-trigger-ord700) was interrupted; re-fire document conveyor after convert DONE.
