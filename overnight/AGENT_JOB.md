...
# Done: par-maintain run 13. Skip: art-* and fam-maintain (ART302).
# Never widen CUS/ORD packs. Never ATU_SRC. Never master.
...
Job this run: pick one accepted but not-yet-documented slice — prefer log-programs from the night residual bind wave. Run Discovery Phase B deepen (behaviour cards from source), update MANIFEST to documented, regenerate COVERAGE, commit on factory branch, stop.
