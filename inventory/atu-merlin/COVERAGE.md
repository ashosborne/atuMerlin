...
- last_updated: `2026-09-08T22:45:56Z` by `document-slices-conveyor`
- notes:
...
| --- | ---: |
| surfaces_total | 71 |
| surfaces `accepted` | 22 |
| surfaces `candidate` | 39 |
| surfaces `deferred` | 3 |
| surfaces `unknown` | 7 |
| behaviours_known | 268 |
| behaviours `candidate` | 161 |
| behaviours `deferred` | 7 |
| behaviours `documented` | 100 |
